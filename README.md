...
<p align="center">
  ...
  <br>
  <sub>🎥 The Cabinet AI 多 Agent 协作全流程演示</sub>
</p>

<details>
<summary>📸 GIF 预览（加载更快）</summary>
<p align="center">
  <img src="docs/demo.gif" alt="The Cabinet Demo" width="100%">
  <br>
  <sub>Directive Intake → Chief of Staff → NSC → White House Counsel → OMB → Cabinet Secretariat → Departments → Presidential Briefing（30 秒）</sub>
</p>
</details>
...
**现实对应：** 美国最高法院的核心权力是 Judicial Review——任何联邦机构的行为，如果被认为违宪，最高法院可以将其推翻。这个权力在 Marbury v. Madison（1803）确立，比三省六部晚了整整 1185 年。
