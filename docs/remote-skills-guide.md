...
U.S. Cabinet Branch现已支持从网上连接和增补 skills 资源，None需手动复制文件。支持从以下来源获取：
...
{
  "ok": true,
  "message": "技能 code_review 已添加到 nsc",
  "skillName": "code_review",
  "agentId": "nsc",
  "source": "https://raw.githubusercontent.com/...",
  "localPath": "/Users/bingsen/.openclaw/workspace-nsc/skills/code_review/SKILL.md",
  "size": 2048,
...
|-----------|------|----------|--------|
| `code_review` | 代码审查（支持 Python/JS/Go） | Department of Defense/Department of Justice | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/code_review/SKILL.md |
| `api_design` | API 设计审查 | Department of Defense/Department of Commerce | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/api_design/SKILL.md |
| `security_audit` | 安全审计 | Department of Justice | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/security_audit/SKILL.md |
| `data_analysis` | 数据分析 | Department of the Treasury | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/data_analysis/SKILL.md |
| `doc_generation` | 文档生成 | Department of State | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/doc_generation/SKILL.md |
| `test_framework` | 测试框架设计 | Department of Commerce/Department of Justice | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/test_framework/SKILL.md |

**一键导入官方 skills**

```bash
python3 scripts/skill_manager.py import-official-hub \
  --agents nsc,wh_counsel,cabinet_sec,defense,justice,state
```
...
compatibleAgents: [defense, justice, wh_counsel]
---
...
- Department of Defense（代码实现）的代码产出审查
- Department of Justice（合规审计）的安全检查
- White House Counsel（审议把关）的质量评估
...
- None法访问 `~/.openclaw/config.json` 等敏感文件
...
A: 检查文件格式：
```bash
python3 -m json.tool ~/.openclaw/workspace-nsc/skills/xxx/SKILL.md
```
