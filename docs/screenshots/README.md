...
| 文件名 | 内容 | 对应面板 |
|--------|------|---------|
| `01-kanban-main.png` | Directive看板总览 | 📋 Directive看板 |
| `02-monitor.png` | agency调度 | 🔭 agency调度 |
| `03-task-detail.png` | 任务流转详情（点击任务卡片展开） | 📋 Directive看板 → 详情 |
...
| `08-memorials.png` | Briefing阁 | 📜 Briefing阁 |
| `09-templates.png` | 旨库（Presidential Directive模板） | 📜 旨库 |
| `10-morning-briefing.png` | 天下要闻 | 📰 天下要闻 |
| `11-ceremony.png` | Situation Room Roll Call仪式动画 | 开场动画 |
