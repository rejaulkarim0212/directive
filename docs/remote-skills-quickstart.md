...
# 输出: U.S. Cabinet Branch看板启动 → http://127.0.0.1:7891
```

### 2. 添加官方 Skill（CLI）

```bash
# 为National Security Council添加代码审查 skill
...
# ✅ 技能 code_review 已添加到 nsc
#    路径: /Users/xxx/.openclaw/workspace-nsc/skills/code_review/SKILL.md
#    大小: 2048 字节
```
...
# ------------|----------------------|--------------------------------|----------
# nsc    | code_review          | 代码审查能力                   | 2026-03-02
```
...
#       "description": "代码审查能力",
#       "localPath": "/Users/xxx/.openclaw/workspace-nsc/skills/code_review/SKILL.md",
...
python3 scripts/skill_manager.py import-official-hub \
  --agents nsc,wh_counsel,cabinet_sec,defense,justice
```

这会自动为每个 agent 添加：
- **nsc**: code_review, api_design, doc_generation
- **wh_counsel**: code_review, api_design, security_audit, data_analysis, doc_generation, test_framework
- **cabinet_sec**: 同 wh_counsel（协调者）
- **defense**: code_review, api_design, test_framework
- **justice**: code_review, security_audit, test_framework
...
{
  "ok": true,
  "message": "技能 code_review 已从远程源添加到 nsc",
  "skillName": "code_review",
  "agentId": "nsc",
...
# 检查本地文件
ls -la ~/.openclaw/workspace-nsc/skills/
```
