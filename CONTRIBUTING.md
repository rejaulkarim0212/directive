...
<p align="center">
  <strong>U.S. Cabinet Branch欢迎各路英雄好汉 ⚔️</strong><br>
  <sub>None论是修一个 typo 还是设计一个新的 Agent 角色，我们都万分感谢</sub>
</p>
...
我们推荐用"Directive"的格式来描述你的需求 —— 就像给President写Briefing一样 😄
...
<p align="center">
  <sub>感谢每一位贡献者，你们是U.S. Cabinet Branch的基石 ⚔️</sub>
</p>
